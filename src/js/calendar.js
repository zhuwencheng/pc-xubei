(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<div class="calendar-hd">',
            '<a href="javascript:;" data-calendar-display-month class="calendar-display">{yyyy}年</a>',
            '<div class="calendar-arrow">',
    ...
    Calendar.prototype = {
        ...
        getDayItem: function(y, m, d, f) {
            ...
            if (dt.isSame(y, m, d)) {
                $item.html('<span>'+d+'</span>');
            }
            if (markData) {
                $item.data(MARK_DATA, markData);
                $item.html('<span>'+d+'</span>');//$item.html(d + MARK_DAY_HTML);
                if(markData=='已回款'){
                    $item.addClass('has-payment');
                }else{
                    $item.addClass('will-payment');
                }
            }
        ...
        getDaysHtml: function(y, m) {
            ...
            return $('<li></li>').width(this.options.width-1).append($days);
        },
        ...
        getDisDateValue: function() {
            var arr = this.$disDate.html().split('年'),
                y = Number(arr[0]),
                m = Number((arr[1].split('月')[0]).match(/\d{1,2}/)[0]);
                ...
                toggleClass = function() {
                    this.$dateItems.children(':eq(1)')
                        ...
                        .filter(function(index) {
                            return (parseInt(this.innerHTML)|| parseInt($(this).find('span').html())) === d;
        ...
        event: function() {
            ...
            _this.$element.on('click', '[' + ITEM_DAY + ']', function() {
                var d = parseInt(this.innerHTML)||parseInt($(this).find('span').html()),
                    cls = getClass(this),
            ...
            _this.$element.on('mouseenter', '[' + ITEM_DAY + ']', function(e) {
                var arr = _this.getDisDateValue(),
                    day = new Date(arr[0], arr[1] - 1, parseInt(this.innerHTML)||parseInt($(this).find('span').html()));
        ...
        resize: function() {
            ...
            this.$element.find('.calendar-ct').width(w-1).height(h-2);
