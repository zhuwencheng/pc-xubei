...
(function ($){
    $.fn.setPager=function(options){
        ...
        that.AjustPage=function(){
            ...
            var firstHtml='<span class="first" data-index="1">第一页</span>';
            var preHtml='<span class="pre" data-index="'+(that.pageindex>1?that.pageindex-1:1)+'">&nbsp;</span>';
            var nextHtml='<span class="next" data-index="'+(that.pageindex+1>that.totalpage?that.totalpage:that.pageindex+1)+'">&nbsp;</span>';
            var lastHtml='<span class="last" data-index="'+that.totalpage+'">最后一页</span>';
            var $numHtml=$('<div></div>');
